...
export function SkillsForm({ onSubmit, initialData }: SkillsFormProps) {
	const form = useForm<SkillsSchema>({
		...
		defaultValues: {
			...
			skillsMatrix: initialData.skillsMatrix.length > 0 ? initialData.skillsMatrix : undefined,
		},
	});
		...
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
				...
				<div className="space-y-4">
					...
					<Button type="button" variant="outline" onClick={() => appendComputerSkill("")}>
				...
				<div className="space-y-4">
					...
					<Button type="button" variant="outline" onClick={() => appendOtherSkill("")}>
						<Plus className="mr-2 h-4 w-4" />
						Add Other Skill
					</Button>
				</div>
