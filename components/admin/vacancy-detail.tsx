...
import { Download, Mail, Phone, Building2, MapPin, Briefcase, FileText, Clock } from "lucide-react";
		...
		<div className="space-y-6">
			<Card>
				...
				<CardContent className="grid gap-4 pt-4 sm:grid-cols-2">
					...
					<div>
						<p className="text-sm font-medium text-muted-foreground">Job Niche</p>
					...
					<div>
						<p className="text-sm font-medium text-muted-foreground">Working Model</p>
						<p className="text-lg">
					...
					<div className="sm:col-span-2">
						...
						<p className="mt-1 whitespace-pre-wrap text-base">{vacancy.jobDescription}</p>
					</div>
				</CardContent>
			</Card>
			...
			<Card>
				...
				<CardContent className="grid gap-4 sm:grid-cols-2">
					...
					<div>
						...
						<p className="text-lg">
							<a href={`mailto:${vacancy.postedByEmail}`} className="text-primary hover:underline">
					...
					<div>
						...
						<p className="text-lg">
							<a href={`tel:${vacancy.postedByMobile}`} className="text-primary hover:underline">
								{vacancy.postedByMobile}
							</a>
						</p>
					</div>
					<div>
						<p className="text-sm font-medium text-muted-foreground">How They Heard About Us</p>
			...
			<Card>
				...
				<CardContent>
					{vacancy.vacancyFilePath ? (
						<Button asChild>
							<a href={vacancy.vacancyFilePath} target="_blank" rel="noopener noreferrer">
