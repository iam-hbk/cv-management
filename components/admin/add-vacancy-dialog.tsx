...
export function AddVacancyDialog() {
	...
	const submitVacancyFromAdmin = useAction(api.vacanciesActions.submitVacancyFromAdmin);
		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="max-h-[90vh] overflow-y-auto">
				<DialogHeader>
					...
					<DialogDescription>
						Add a vacancy. It will be created as approved. Upload a document (PDF, DOC, etc.).
					</DialogDescription>
				</DialogHeader>
				<Form {...form}>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									...
									<FormControl>
										<Textarea {...field} rows={3} placeholder="Job description" />
									</FormControl>
									<FormMessage />
								</FormItem>
							)}
