		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
				<DialogHeader>
					...
					<DialogDescription>Make changes to the vacancy details below.</DialogDescription>
				</DialogHeader>
					...
					<div className="grid gap-4 sm:grid-cols-2">
						...
						<div className="space-y-2">
							...
							<Input
								...
								onChange={(e) => setFormData({ ...formData, jobNiche: e.target.value })}
								required
							/>
						</div>
						<div className="space-y-2">
							...
							<Input
								...
								onChange={(e) => setFormData({ ...formData, jobRegion: e.target.value })}
								required
							/>
						</div>
						<div className="space-y-2">
						...
						<div className="space-y-2">
							...
							<Input
								...
								onChange={(e) => setFormData({ ...formData, postedByMobile: e.target.value })}
								required
							/>
						</div>
					</div>
