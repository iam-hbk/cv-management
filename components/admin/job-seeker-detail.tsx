	...
	return (
		<div className="space-y-6">
			...
			<Card>
				...
				<CardContent className="grid gap-4 sm:grid-cols-2">
					<div>
						...
						<p className="text-lg">
							<a href={`mailto:${jobSeeker.email}`} className="text-primary hover:underline">
								{jobSeeker.email}
							</a>
						</p>
					</div>
					<div>
						...
						<p className="text-lg">
							<a href={`tel:${jobSeeker.mobileNumber}`} className="text-primary hover:underline">
			...
			<Card>
				...
				<CardContent className="grid gap-4 sm:grid-cols-2">
					<div>
						<p className="text-sm font-medium text-muted-foreground">Current Salary Rate</p>
						<p className="text-lg">{jobSeeker.currentSalaryRate}</p>
					</div>
					<div>
						<p className="text-sm font-medium text-muted-foreground">Current Salary Range</p>
			...
			<Card>
				<CardContent className="pt-6">
					<p className="text-sm text-muted-foreground">
						Submitted on {format(new Date(jobSeeker._creationTime), "MMMM d, yyyy 'at' h:mm a")}
					</p>
				</CardContent>
			</Card>
		</div>
