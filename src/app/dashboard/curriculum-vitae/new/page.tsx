...
export default function NewCVPage() {
  ...
  useEffect(() => {
    ...
    loadAIExtractedData();
  }, [setPersonalInfo, setExecutiveSummary, setWorkExperience, setEducation, setSkills, updateStepCompletion]);
          ...
          <div className="space-y-6">
            ...
            {education.length > 0 && (
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C6.5 6.5 2 10.5 2 15.5S6.5 24.5 12 24.5s10-4 10-9-4.5-9-10-9z" />
                    </svg>
                    Education
                  </CardTitle>
                </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 20l4-16m4 4l4 4m0 6V4m0 0L8 4m6 16v-2m0 0l-4-4" />
                  </svg>
                  Skills
                </CardTitle>
              </CardHeader>
