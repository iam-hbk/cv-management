...
const defaultExecutiveSummary: ExecutiveSummarySchema = {
  executiveSummary:
    "*Must be removed* A long executive summary to be written here...",
  jobTitle: "",
};
...
export const cvFormAtom = atomWithStorage<CVFormState>(
  "cv-form-storage",
  initialState,
);
...
export const updateStepCompletionAtom = atom(
  null,
  (get, set, stepId: Step["id"]) => {
